// A simple loader component for the office chair GLB model
...
// Component that renders the office chair 3D model
// It accepts group props so you can position/rotate/scale the whole model
export default function OfficeChair(props: React.ComponentProps<'group'>) {
  // Load the GLB file from the public directory
  const gltf = useGLTF('/office_chair.glb') as unknown as GLTF
